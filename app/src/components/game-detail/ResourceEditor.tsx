          ...
          <div key={r.id} className="rounded-2xl bg-white/[0.03] p-3 ring-1 ring-white/10">
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white/[0.06] ring-1 ring-white/10 transition hover:bg-white/10"
              ...
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl text-lg text-slate-500 transition hover:bg-rose-400/10 hover:text-rose-400"
              ...
              <div className="mt-2 flex flex-wrap gap-1.5 rounded-2xl bg-white/[0.04] p-2 ring-1 ring-white/10">
                {RESOURCE_ICON_KEYS.map((key) => (
                  <button
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/[0.06] ring-1 transition hover:bg-white/10"
                    style={{
                      boxShadow:
