/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-env.d.ts` (hash: a7fe56452e3ffa37a97265489a415995)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://staging.example.invalid" | "https://app.example.invalid" | "http://localhost:5173,http://127.0.0.1:5173";
	SYNC_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGINS" | "SYNC_TOKEN">> {}
}
